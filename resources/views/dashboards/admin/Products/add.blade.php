                      ...
                      <div class="row" style="padding: 30px;">
                          ...
                          <div class="col-md-6"   >
                              <div class="form-group">
                                  ...
                                  <input type="number" name="priority" min="0"  class="form-control" required>
                              </div>
                          </div>
                  ...
                  <div class="tab-pane fade" id="pstatus" role="tabpanel" aria-labelledby="pstatus-tab">
                      ...
                      <div class="row" style="padding:30px;">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" name="delivery_charges" min="1" placeholder="Delivery Charges " required>
                              </div>
                          </div>
                              <div class="col-md-12">
                                  <div class="form-group">
