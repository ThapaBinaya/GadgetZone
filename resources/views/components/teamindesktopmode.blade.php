<h1 class="black-text" style="font-weight:bold;">OUR TEAM</h1>
    ...
    <br>
      ...
      <div class="row team px-5 wow animated fadeIn slow" style="margin-left:15%;"   >
          ...
          <div class="col-md-3" >
                <div class="card mb-2">
                    <img class="card-img-top  animated pulse infinite slow" src="{{asset('assets/img/team/Binaya.jpg')}}"
                      alt="Card image cap">
                    <div align="left" class="card-body">
                      <h6 class="card-title font-weight-bold" style="font-family: 'Josefin Sans', sans-serif;">Binaya</h6>
      ...
      <div class="row team px-5 py-5 wow animated fadeIn slow" style="margin-left:15%;"   >
            <div class="col-md-3" >
              <div class="card mb-2">
                  <img class="card-img-top  animated pulse infinite slow" src="{{asset('assets/img/team/sudip.jpg')}}"
                    alt="Card image cap">
                  <div align="left" class="card-body">
                    <h6 class="card-title font-weight-bold" style="font-family: 'Josefin Sans', sans-serif;">Sudip</h6>
                    <p class="card-text" style="font-family: 'Balsamiq Sans', cursive;margin-top:-12px;font-size:10px;"><i> Desgination</i></p>
