        ...
        <div class="container">
            <div class="row d-flex align-items-center " >
                <section align="center" style="padding:20px;"  class="wow fadeInUp" >
                        <h1 class="black-text" align="center" style="font-weight:bold;">TESTIMONIALS</h1>
                                            ...
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                            ...
                                                            <p align="left" style="float:left;">
                                                                <img src="{{asset('assets/img/testimonials/Binaya.jpg')}}" class="z-depth-1" style="width:100px;">
                                                            </p>
                                                            <p ><span style="font-weight:bold;">Binaya Thapa</span> <br>Freelauncer</p>
                                                            <br><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-2">
                                                <div class="card-body">
                                                            ...
                                                            <p align="left" style="float:left;">
                                                                <img src="{{asset('assets/img/testimonials/sudip.jpg')}}" class="z-depth-1" style="width:100px;">
                                                            </p>
                                                            <p ><span style="font-weight:bold;">Sudip Kumar Bajgain</span> <br>Freelauncer</p>
                                                            <br><br>
                                                            <p align="left" class="card-text" style="font-family: 'Balsamiq Sans', cursive;display:block;">
                                                                <i>Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat tarad limino ata 
                                                                Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat tarad limino ata
