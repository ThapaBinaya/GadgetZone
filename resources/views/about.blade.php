@extends('layout')
@section('title') GadgetZone About Us @endsection
...
THE GADGETZONE STORY</h3>
<p class="white-text" style="font-weight:bold;">    JOURNEY OF GADGETZONE FROM IDEATION TO STARTUP</p>
