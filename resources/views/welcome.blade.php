...
<script>
 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br>
      <div class="row ">
        <div class="col-md-4 wow animated zoomIn slow" style="padding: 40px;">
          <img src="{{asset('Img/about.jpg')}}" alt="" class="img-fluid" style="border-radius: 20px; box-shadow: 0px 0px 5px 2px;">
        </div>
        <div  align="center" class="col-md-8 wow animated flash slow">
            <h1 class="black-text" style="font-weight:bold;">Values of  GadgetZone</h1>
            ...
            <div class="row my-5" style="font-size:30px; font-family: 'Balsamiq Sans', cursive;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                        <li><i class="fas fa-snowflake"></i> Quality Assurance</li><br>
                        <li><i class="fas fa-snowflake"></i> Fast and Reliable Shipping</li>
                    </ul>
              </div>
              <div class="col-md-6">   
                    <ul align="left" style="list-style:none;">
                    <li><i class="fas fa-snowflake"></i> Convenient Online Shopping</li><br>
                    <li><i class="fas fa-snowflake"></i> Competitive Prices</li>
                  </ul>
              </div>
            </div>
...
<section id="Products" align="center" class="px-5 wow animated fadeInUpBig fast" style=" font-family: 'Balsamiq Sans', cursive;">
    ...
    <h1 class="black-text" align="center" style="font-weight:bold; ">PRODUCTS</h1> 
    <div align="center">
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-map-marker-alt"></i>
                    <h4>Location:</h4>
                    <p>  Kavre, Banepa - 45210</p>
                  </div>

                  <div class="email">
                  <i class="fas fa-envelope"></i>
                    <h4>Email:</h4>
                    <p>gadgetzone2023@gmail.com</p>
                  </div>

                  <div class="phone">
                  <i class="fas fa-phone"></i>
                    <h4>Call:</h4>
                    <p>Binaya : +977 9876543210<br>
                       Sudip  : +977 9876543211</p>
                  </div>

                  <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d5490.262972517143!2d85.52298527828691!3d27.630476776220437!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2snp!4v1688880100524!5m2!1sen!2snp" width="100%" height="290" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
